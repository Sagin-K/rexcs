...
function accAdd(a){
	...
	var gList=new Array("id","trans_no2","pstn_no" ,"pstn_code","serv_make" ,"reg2_ip" ,"transform2" ,"gw_id2","vlan","remark","phone","mac","icom_no");
...
function scanDatabase(f,c){
	...
	var fList=new Array("id" ,"trans_no2" ,"mac","pstn_no","pstn_code" ,"serv_make","reg2_ip","transform2","gw_id2","trans_no1","trans_no2","vlan","icom_no","icom_no","phone")
